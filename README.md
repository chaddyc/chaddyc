...
![skills](https://skillicons.dev/icons?i=linux,docker,kubernetes,git,github,bash,go,python,javascript,typescript,cloudflare,nginx,aws,gcp,mysql,postgres,vim,vscode&theme=light)
